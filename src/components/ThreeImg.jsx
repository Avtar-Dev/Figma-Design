  ...
  const texts = [
    {
      ...
      text: "Body text for whatever you’d like to add more to the subheading h hhhhhhh hhhhh hhhhhh hhhhhhh hhhh hh.",
    },
    {
      subHeading: "Subheading",
  ...
  return (
    <div className="flex flex-col gap-8 sm:flex sm:flex-col sm:gap-10">
      ...
      <div className="flex flex-col gap-4 items-center sm:w-full sm:flex sm:flex-row sm:justify-between sm:items-start sm:gap-20">
        <div className="xl:w-100 inline-flex flex-col justify-start items-start gap-6 flex-1 xl:items-stretch">
